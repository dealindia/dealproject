...
gulp.task('run', ['compile-font', 'watch-html', 'watch-js', 'watch-scss', 'watch-test-js','images'], () => {
...
gulp.task('images', function() {
    gulp.src('src/main/webapp/images/**/*.png')
    .pipe(gulp.dest('target/gulp/main/images'))
});